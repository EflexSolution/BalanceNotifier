// src/lib.rs
/*
 * Core library for BalanceNotifier
 */
...
#[derive(Debug)]
pub struct BalanceNotifierProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BalanceNotifierProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BalanceNotifier processing");
    
    let mut processor = BalanceNotifierProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BalanceNotifierProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BalanceNotifierProcessor::new(false);
